 ...
 */
function _possibleConstructorReturn(n,t){if(!n)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t&&(typeof t=="object"||typeof t=="function")?t:n}function _inherits(n,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof t);n.prototype=Object.create(t&&t.prototype,{constructor:{value:n,enumerable:!1,writable:!0,configurable:!0}});t&&(Object.setPrototypeOf?Object.setPrototypeOf(n,t):n.__proto__=t)}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function uuidv4(){return([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,n=>(n^crypto.getRandomValues(new Uint8Array(1))[0]&15>>n/4).toString(16))}function search(n,t){const r=new Date;n.blur();const i=document.getElementById("content");setHeader("Søker i d:sak etter");setSubHeader(t);clearSearchResults(i);showProgressBar(i);doSearch(t,i,r)}function clearSearchResults(n){const t=document.getElementById("search-results");t&&n.removeChild(t);const i=document.getElementById("search-duration");i&&n.removeChild(i)}function showProgressBar(n){removeProgressBar(n);const t=document.createElement("div");t.classList.add("progress");t.id="progress-bar";const i=document.createElement("div");i.classList.add("indeterminate");t.appendChild(i);n.appendChild(t)}function removeProgressBar(n){const t=document.getElementById("progress-bar");t&&n.removeChild(t)}function setHeader(n){const t=document.getElementById("search-header"),i=document.createTextNode(n);t.replaceChild(i,t.firstChild)}function setSubHeader(n){const t=document.getElementById("search-tagline"),i=document.createTextNode(n);t.replaceChild(i,t.firstChild)}function doSearch(n,t,i){const r=new XMLHttpRequest;r.onreadystatechange=function(){if(this.readyState==4){const n=document.getElementById("content");if(this.status==200){const t=r.getResponseHeader("callId");t===callId&&addSearchResults(this.response,n,i)}else clearSearchResults(n),removeProgressBar(n),setHeader("Søket mot d:sak feilet"),setSubHeader(this.status+" "+this.statusText)}};r.open("POST","/search");r.setRequestHeader("Content-Type","application/json;charset=UTF-8");callId=""+uuidv4();r.setRequestHeader("callId",callId);const u=JSON.stringify(n);r.send(u)}function addSearchResults(n,t,i){clearSearchResults(t);removeProgressBar(t);const r=JSON.parse(n);if(setHeader(r.header),r.query){document.title=r.query+" - "+originalTitle;const n=new URLSearchParams(window.location.search);n.set(queryParameter,r.query);const t="/?"+n.toString();history.pushState({},"",t);setSubHeader(r.query)}r.tickets.length>0&&createResultTable(r,t);writeSearchDuration(t,i,r.numberOfTickets)}function createResultTable(n,t){const r=document.createElement("tr");let i=document.createElement("th");i.innerHTML="Id";r.appendChild(i);i=document.createElement("th");i.innerHTML="Tittel";r.appendChild(i);i=document.createElement("th");i.innerHTML="Registrert dato";i.classList.add("no-break");r.appendChild(i);i=document.createElement("th");i.innerHTML="Kunde";r.appendChild(i);i=document.createElement("th");i.innerHTML="TFS";r.appendChild(i);const u=document.createElement("table");u.classList.add("striped");u.id="search-results";const e=document.createElement("thead"),f=document.createElement("tbody");f.id="result-body";e.appendChild(r);u.appendChild(e);u.appendChild(f);t.appendChild(u);n.tickets.forEach(function(n){addSearchResult(f,n)})}function addSearchResult(n,t){const e=new Intl.DateTimeFormat("nb-NO",{year:"numeric",month:"numeric",day:"numeric",hour:"2-digit",minute:"2-digit"}),o=new Date(t.createdAt);let f="https://support.dips.no/bin/ticket.fcgi?ticketId="+t.id,r=document.createElement("a");r.setAttribute("href",f);r.setAttribute("target","_blank");r.innerHTML=t.id;const u=document.createElement("tr");let i=document.createElement("td");i.appendChild(r);u.appendChild(i);i=document.createElement("td");i.innerHTML=t.title;u.appendChild(i);i=document.createElement("td");i.innerHTML=e.format(o);i.classList.add("no-break");u.appendChild(i);i=document.createElement("td");i.innerHTML=t.customer;u.appendChild(i);f="http://vd-tfs03:8080/tfs/DefaultCollection/DIPS/_workitems?_a=edit&id="+t.tfs;r=document.createElement("a");r.setAttribute("href",f);r.setAttribute("target","_blank");r.innerHTML=t.tfs;i=document.createElement("td");i.appendChild(r);u.appendChild(i);n.appendChild(u)}function writeSearchDuration(n,t,i){const o=Math.abs(new Date-t),s=o/1e3,f=Math.round((s+1e-5)*100)/100,u=document.createElement("div");u.id="search-duration";u.classList.add("row");const e=document.createElement("p"),r=document.createElement("span");r.classList.add("grey-text");i===0?r.appendChild(document.createTextNode("Fant ingen d:saker ("+f+" sekunder)")):i===1?r.appendChild(document.createTextNode("Fant 1 d:sak ("+f+" sekunder)")):r.appendChild(document.createTextNode("Fant "+i+" d:saker ("+f+" sekunder)"));e.appendChild(r);u.appendChild(e);n.appendChild(u)}var _get=function get(n,t,i){var r,u,f;return n===null&&(n=Function.prototype),r=Object.getOwnPropertyDescriptor(n,t),r===undefined?(u=Object.getPrototypeOf(n),u===null?undefined:get(u,t,i)):"value"in r?r.value:(f=r.get,f===undefined)?undefined:f.call(i)},_createClass=function(){function n(n,t){for(var i,r=0;r<t.length;r++)i=t[r],i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}return function(t,i,r){return i&&n(t.prototype,i),r&&n(t,r),t}}(),Component,docHandleKeydown,docHandleKeyup,getTime,$jscomp,$jscomp$this;
